...
onMounted(async () => {
  ...
  const res = await getConsultOrderDetail(itemId as string);
  item.value = res.data;
  ...
  <div class="consult-detail-page" v-if="item">
    ...
    <div class="detail-head">
      <div class="text">
        ...
        <span class="sta">{{ item.statusValue }}</span>
    ...
    <div class="detail-patient">
      <van-cell-group :border="false">
        ...
        <van-cell
          title="患病时长"
          :value="getIllnessTime(item.illnessTime || 1)"
        />
        <van-cell
          title="就诊情况"
          :value="getConsultFlag(item.consultFlag || 1)"
        />
