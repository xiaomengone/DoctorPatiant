...
import { ref } from "vue";
import { useFollowInterestLogic } from "@/composables/index";

defineProps<{
  item: resFollowDoctorsItem;
}>();
const { followInterest, loading } = useFollowInterestLogic();
</script>
<template>
